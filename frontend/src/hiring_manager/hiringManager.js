...
import PostVaccancy from './postVaccancy';
...
const HiringManager = () => {
    ...
    const routes = [
        {
            path: '/hiringManager/postVaccancy/',
            component: PostVaccancy
        },
        {
            path: '/hiringManager/listVaccancies',
            component: ListVacancies
        },
        {
            path: '/hiringManager/interviewHistory/',
    ...
    if (userInfo != null && userInfo.user.designation.length == 3) {
        ...
        userInfo.user.designation.map((i) => i.id != 2 ? i.id == 1 ? isAdminManager = true : isTalentManager = true : 1);
        ...
        <BrowserRouter>
            ...
            <div className={classes.root}>
                ...
                >
                    ...
                    <Divider />
                    <List>
                        <NavLink to="/hiringManager/postVaccancy/" className={classes.navlink} onClick={clicked}>
                            <ListItem button>
                                <ListItemIcon className={classes.icons}>
                                    <ShoppingCartIcon />
                                </ListItemIcon>
                                <ListItemText primary="Post vaccancy" />
                            </ListItem>
                        </NavLink>
                        <NavLink to="/hiringManager/listVaccancies/" className={classes.navlink} onClick={clicked}>
                            <ListItem button>
                                <ListItemIcon className={classes.icons}>
                                    <PeopleIcon />
                                </ListItemIcon>
                        ...
                        <NavLink to="/hiringManager/interviewHistory/" className={classes.navlink} onClick={clicked}>
                            <ListItem button>
                                <ListItemIcon className={classes.icons}>
                                    <LayersIcon />
                                </ListItemIcon>
                                <ListItemText primary="Hire Applicants" />
                            </ListItem>
                        </NavLink>
                    </List>
                    <Divider />
                    <List>
                        <div>
                            {(isAdminManager || isTalentManager) && <ListSubheader inset>Other Profiles</ListSubheader>}
