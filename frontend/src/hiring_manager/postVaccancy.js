    ...
    return (
        ...
        <Formik
            ...
            onSubmit={(data, { setSubmitting, resetForm }) => {
                ...
                const postData = {
                    'hiringManager': userInfo.user.id,
                    'vac_name': data.vac_name,
                    'vac_designation': data.vac_designation,
                    'project_name': data.project_name,
                    'comments': data.comments,
                    'yrs_of_exp': data.yrs_of_exp,
                    'no_of_vacancies': data.no_of_vacancies,
                    'skills': data.skills,
                    'vac_location': data.location
                };
                console.log(postData);
                axios.post('http://127.0.0.1:8000/hiringManager/register/',
                    postData)
                    .then(
                        data => {
                            console.log(data);
        ...
        >
            {({ values, errors, isSubmitting }) => (
                <Form>
                    <div>
                        <MyTextField label="vacancy name" placeholder="vac name" name="vac_name" />
                        <MyTextField label="vacancy designation" placeholder="vac designation" name="vac_designation" />
                    </div>
                    <div>
                        <MyTextField label="project name" placeholder="project_name" name="project_name" />
                        <MyTextField label="comments" placeholder="comments" name="comments" />
                    </div>
                    <div className={classes.paper}> 
                    <div>number of vacancies:</div>
                    <Field

                        name="no_of_vacancies"
                        type={"number"}
                        defaultValue={2}
                        placeholder="no_of_vacancies"
